...
syn keyword sasStatement  MODIFY OUTPUT PAGE PAGEBY PLOT PUT REDIRECT REMOVE 
syn keyword sasStatement  RENAME REPLACE RETAIN RETURN SET SKIP STARTSAS STOP SYMGET UPDATE
...
syn keyword sasFunction  BYTE CALL CAT CATS CATT CATX CDF CEIL CEXIST CINV CLOSE 
...
syn keyword sasFunction  ROUND SAVING SCAN SDF SIGN SIN SINH STRIP
